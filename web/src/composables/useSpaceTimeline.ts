...
/**
 * Strip markdown wrappers for a sidebar snippet without touching underscores.
 * TOOL_FAIL and similar tokens must survive (the old `/[#*`_[\]()>]/` class
 * ate the `_` and rendered "TOOLFAIL").
 */
export function plaintextPreview(content: string, maxLen = 48): string {
