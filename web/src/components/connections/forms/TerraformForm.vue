<template>
  <div class="flex flex-col gap-3">
    <div>
      ...
      <input v-model="form.apiToken" type="password" data-testid="field-api-token" class="field" placeholder="••••••••" :disabled="testing || saving" />
    </div>
    <div>
...
const form = reactive({ apiToken: '', label: '' })
defineExpose({ getPayload: () => ({ token: form.apiToken, label: form.label }) })
</script>
